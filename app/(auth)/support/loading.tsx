...
export default function SupportLoading() {
  return (
    <div className="flex flex-col lg:flex-row min-h-screen w-full bg-[var(--color-bg)]">
      <aside className="hidden lg:flex flex-col w-64 shrink-0 max-h-svh bg-surface-1 border-r border-border p-6">
        <div className="mb-10 px-3 py-2">
          <div className="h-5 w-16 rounded bg-surface-3 animate-pulse" />
        </div>
