  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 text-center px-6">
      ...
      <div className="flex flex-col gap-2 max-w-xs">
        ...
        <p className="text-sm text-[var(--color-on-dim)] leading-relaxed">
          <span className="text-[var(--color-primary)] font-semibold">{title}</span>{" "}
      ...
      <Link
        href="/profile"
        className="h-10 px-6 rounded-xl bg-[var(--color-surface-3)] border border-white/5 hover:border-white/10 text-xs font-semibold tracking-wider text-[var(--color-on-surface)] hover:-translate-y-0.5 transition-all"
      >
        ← Volver a Perfil
      </Link>
    </div>
